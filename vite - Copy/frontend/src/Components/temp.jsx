  ...
  return (
    <StyledWrapper className='mt-10 ml-10 hidden sm:block'>
      <div className="card ">
        ...
        <p className="main-text text-white">24°</p>
        <div className="info">
          <div className="info-left">
            <p className="text-gray mb-14">Home Temp</p>
            <p className='text-white -mt-8 opacity-75 text-[15px]'>Last Updated</p>
          </div>
          <p className="hum text-white text-[36px] opacity-92 font-normal left-0 -mt-5">96% <br /> <p className=" text-gray-300 text-[15px] opacity-75">Home Humidity</p>
          </p>
        </div>
      </div>
    </StyledWrapper>
