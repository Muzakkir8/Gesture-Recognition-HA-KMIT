...
const Dashboard = () => {
  ...
  return (
    <div className="transition-all duration-200 ease-in-out  dark:bg-slate-900">
  ...
  <div className="humid text-center flex items-center gap-2">
    ...
    <div>
      ...
      {/* Main content area */}
      <div className="bg-[#e8eaf6] dark:bg-slate-700 w-full max-w-[90vw] mx-auto rounded-lg p-6 mt-4 lg:max-w-[1410px] md:max-w-[800px] min-h-[calc(100vh-100px)] lg:ml-[80px]">
